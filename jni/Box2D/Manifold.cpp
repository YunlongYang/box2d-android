...
JNIEXPORT jint JNICALL Java_box2d_Manifold_jniGetType
  (JNIEnv *, jobject, jlong addr) {
	b2Manifold* manifold = (b2Manifold*)addr;
	return manifold->type;
}

JNIEXPORT jint JNICALL Java_box2d_Manifold_jniGetPointCount
  (JNIEnv *, jobject, jlong addr) {
  	b2Manifold* manifold = (b2Manifold*)addr;
	return manifold->pointCount;
}

JNIEXPORT void JNICALL Java_box2d_Manifold_jniGetLocalNormal
...
JNIEXPORT void JNICALL Java_box2d_Manifold_jniGetLocalPoint
  (JNIEnv *env, jobject, jlong addr, jfloatArray values) {
	b2Manifold* manifold = (b2Manifold*)addr;
	float* tmp = (float*)env->GetPrimitiveArrayCritical( values, 0 );  
...
JNIEXPORT jint JNICALL Java_box2d_Manifold_jniGetPoint
