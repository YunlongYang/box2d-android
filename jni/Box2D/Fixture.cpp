 ...
 * Signature: (J)I
 */
JNIEXPORT jint JNICALL Java_box2d_Fixture_jniGetType
 ...
 * Signature: (JZ)V
 */
JNIEXPORT void JNICALL Java_box2d_Fixture_jniSetSensor
 ...
 * Signature: (J)Z
 */
JNIEXPORT jboolean JNICALL Java_box2d_Fixture_jniIsSensor
  (JNIEnv *, jobject, jlong addr)
{
	b2Fixture* fixture = (b2Fixture*)addr;
 ...
 * Signature: (JSSS)V
 */
JNIEXPORT void JNICALL Java_box2d_Fixture_jniSetFilterData
 ...
 * Signature: (J[S)V
 */
JNIEXPORT void JNICALL Java_box2d_Fixture_jniGetFilterData
 ...
 * Signature: (JF)V
 */
JNIEXPORT void JNICALL Java_box2d_Fixture_jniSetDensity
 ...
 * Signature: (J)F
 */
JNIEXPORT jfloat JNICALL Java_box2d_Fixture_jniGetDensity
  (JNIEnv *, jobject, jlong addr)
{
	b2Fixture* fixture = (b2Fixture*)addr;
 ...
 * Signature: (J)F
 */
JNIEXPORT jfloat JNICALL Java_box2d_Fixture_jniGetFriction
  (JNIEnv *, jobject, jlong addr)
{
	b2Fixture* fixture = (b2Fixture*)addr;
 ...
 * Signature: (JF)V
 */
JNIEXPORT void JNICALL Java_box2d_Fixture_jniSetFriction
 ...
 * Signature: (J)F
 */
JNIEXPORT jfloat JNICALL Java_box2d_Fixture_jniGetRestitution
  (JNIEnv *, jobject, jlong addr)
{
	b2Fixture* fixture = (b2Fixture*)addr;
 ...
 * Signature: (JF)V
 */
JNIEXPORT void JNICALL Java_box2d_Fixture_jniSetRestitution
 ...
 * Signature: (JFF)Z
 */
JNIEXPORT jboolean JNICALL Java_box2d_Fixture_jniTestPoint
...
JNIEXPORT jlong JNICALL Java_box2d_Fixture_jniGetShape
  (JNIEnv *, jobject, jlong addr)
{
	b2Fixture* fixture = (b2Fixture*)addr;
