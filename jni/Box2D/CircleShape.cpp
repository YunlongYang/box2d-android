 ...
 * Signature: ()J
 */
JNIEXPORT jlong JNICALL Java_box2d_CircleShape_newCircleShape
  (JNIEnv *, jobject)
{
 ...
 * Signature: (J[F)V
 */
JNIEXPORT void JNICALL Java_box2d_CircleShape_jniGetPosition
 ...
 * Signature: (JFF)V
 */
JNIEXPORT void JNICALL Java_box2d_CircleShape_jniSetPosition
