...
/*
 * Class:     box2d_joints_MouseJoint
 * Method:    jniSetTarget
 * Signature: (JFF)V
 */
JNIEXPORT void JNICALL Java_box2d_joints_MouseJoint_jniSetTarget
 ...
 * Signature: (J[F)V
 */
JNIEXPORT void JNICALL Java_box2d_joints_MouseJoint_jniGetTarget
 ...
 * Signature: (JF)V
 */
JNIEXPORT void JNICALL Java_box2d_joints_MouseJoint_jniSetMaxForce
 ...
 * Signature: (J)F
 */
JNIEXPORT jfloat JNICALL Java_box2d_joints_MouseJoint_jniGetMaxForce
 ...
 * Signature: (JF)V
 */
JNIEXPORT void JNICALL Java_box2d_joints_MouseJoint_jniSetFrequency
 ...
 * Signature: (J)F
 */
JNIEXPORT jfloat JNICALL Java_box2d_joints_MouseJoint_jniGetFrequency
  (JNIEnv *, jobject, jlong addr)
{
	b2MouseJoint* joint = (b2MouseJoint*)addr;
 ...
 * Signature: (JF)V
 */
JNIEXPORT void JNICALL Java_box2d_joints_MouseJoint_jniSetDampingRatio
 ...
 * Signature: (J)F
 */
JNIEXPORT jfloat JNICALL Java_box2d_joints_MouseJoint_jniGetDampingRatio
  (JNIEnv *, jobject, jlong addr)
{
	b2MouseJoint* joint = (b2MouseJoint*)addr;
