...
/*
 * Class:     box2d_CircleShape
 * Method:    newCircleShape
 * Signature: ()J
 */
extern "C" JNIEXPORT jlong JNICALL Java_box2d_CircleShape_newCircleShape
  (JNIEnv *, jobject)
{
 ...
 * Signature: (J[F)V
 */
extern "C" JNIEXPORT void JNICALL Java_box2d_CircleShape_jniGetPosition
 ...
 * Signature: (JFF)V
 */
extern "C" JNIEXPORT void JNICALL Java_box2d_CircleShape_jniSetPosition
